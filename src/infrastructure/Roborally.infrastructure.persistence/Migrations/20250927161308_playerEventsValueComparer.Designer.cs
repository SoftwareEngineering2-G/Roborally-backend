...
namespace Roborally.infrastructure.persistence.Migrations
{
    ...
    [Migration("20250927161308_playerEventsValueComparer")]
    partial class playerEventsValueComparer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Roborally.core.domain.Player.Events.PlayerEvent", b =>
                {
                    ...
                    b.HasIndex("PlayerGameId", "PlayerUsername");
            ...
            modelBuilder.Entity("Roborally.core.domain.Player.Events.PlayerEvent", b =>
                {
                    b.HasOne("Roborally.core.domain.Player.Player", null)
                        ...
                        .HasForeignKey("PlayerGameId", "PlayerUsername");
                });
